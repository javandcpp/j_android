...
JNIEXPORT void JNICALL Java_com_guagua_mp3recorder_util_LameUtil_init(
...
JNIEXPORT jint JNICALL Java_com_guagua_mp3recorder_util_LameUtil_encode(
...
JNIEXPORT jint JNICALL Java_com_guagua_mp3recorder_util_LameUtil_flush(
